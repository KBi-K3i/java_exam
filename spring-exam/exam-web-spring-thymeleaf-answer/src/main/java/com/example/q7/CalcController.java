...
//		if(!isNumber(form.getLeft())) {
//			result.rejectValue("left", null, "左のテキストボックスには数値を入力してください。");
//		}
//		if(!isNumber(form.getRight())) {
//			result.rejectValue("right", null, "右のテキストボックスには数値を入力してください。");
//		}
...
//	 * 数値かどうかをチェックします.
//	 * @param チェックする文字列
//	 * @return 数値の場合:true それ以外の場合:false
//	 */
